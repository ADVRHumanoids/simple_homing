...
simple_homing::simple_homing(std::string module_prefix, 
    ...
    torso_chain_interface( "torso", module_prefix, std::string(rf.find("robot_name").asString()), false),
    left_arm_chain_interface( "left_arm", module_prefix, std::string(rf.find("robot_name").asString()), false),
    right_arm_chain_interface( "right_arm", module_prefix, std::string(rf.find("robot_name").asString()), false),
    left_leg_chain_interface( "left_leg", module_prefix, std::string(rf.find("robot_name").asString()), false),
    right_leg_chain_interface( "right_leg", module_prefix, std::string(rf.find("robot_name").asString()), false),
