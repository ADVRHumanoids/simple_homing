...
simple_homing::simple_homing(std::string module_prefix, 
    ...
    torso_chain_interface( "torso", module_prefix, get_robot_name(), false),
    left_arm_chain_interface( "left_arm", module_prefix, get_robot_name(), false),
    right_arm_chain_interface( "right_arm", module_prefix, get_robot_name(), false),
    left_leg_chain_interface( "left_leg", module_prefix, get_robot_name(), false),
    right_leg_chain_interface( "right_leg", module_prefix, get_robot_name(), false),
